...
int temp_sensor = A5;       // Pin DS18B20 Sensor is connected to
...
byte smiley[] = {B00000000,B00000000,B01100110,B01100110,B00000000,B01000010,B00100100,B00011000};
byte frowney[] = {B00000000,B00000000,B01100110,B01100110,B00000000,B00000000,B00111100,B01000010};
...
if(timeCount <  20) 
{
  if (temperature >= 10 && temperature <= 82.2222) 
  {
   drawScreen(X);
  }
  else 
...
void drawScreen(byte buffer2[])
 { 
  for (int hunterWasHere = 0; hunterWasHere < 300; hunterWasHere++){
    ...
    for (byte i = 0; i < 8; i++)        // count next row
     {
        ...
        for (byte a = 0; a < 8; a++)    // count next row
        {
          ...
          delayMicroseconds(100);       // uncomment delay for different speed of display
